	...
	<div id="container">
		...
		?>	
			<div id="content_main" class="finder">
				...
				<ul>
				<li>
					<h2><a href="finder_sort.php?sort=fixed&cat=police" title ="Fixed">Fixed Blade</a></h2>
					<p>
					</p>
				</li>
				<li>
					<h2><a href="finder_sort.php?sort=folding&cat=police" title ="Folding">Folding Blade</a></h2>
					<p>
					</p>
				</li>			
			</ul>
