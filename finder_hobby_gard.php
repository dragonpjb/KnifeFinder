	...
	<div id="container">
		...
		?>	
			<div id="content_main" class="finder">
				<h1>Gardening Knives</h1>	  
				<ul>
				<li>
					<h2><a href="finder_sort.php?sort=fixed&cat=gardening" title ="Fixed">Fixed Blade</a></h2>
					<p>
					</p>
				</li>
				<li>
					<h2><a href="finder_sort.php?sort=folding&cat=gardening" title ="Folding">Folding Blade</a></h2>
					<p>
					</p>
				</li>			
			</ul>
