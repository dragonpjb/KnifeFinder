	...
	<div id="container">
		...
		?>	
			<div id="content_main" class="finder">
				<h1>Wood Carving Knives</h1>	  
				<ul>
				<li>
					<h2><a href="finder_sort.php?sort=fixed&cat=carving" title ="Fixed">Fixed Blade</a></h2>
					<p>
					</p>
				</li>
				<li>
					<h2><a href="finder_sort.php?sort=folding&cat=carving" title ="Folding">Folding Blade</a></h2>
					<p>
					</p>
				</li>			
			</ul>
