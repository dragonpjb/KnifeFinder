	...
	<div id="container">
		...
		?>	
			<div id="content_main" class="finder">
				<h1>Military Knives</h1>	  
				<ul>
				<li>
					<h2><a href="finder_sort.php?sort=fixed&cat=military" title ="Fixed">Fixed Blade</a></h2>
					<p>
					</p>
				</li>
				<li>
					<h2><a href="finder_sort.php?sort=folding&cat=military" title ="Folding">Folding Blade</a></h2>
					<p>
					</p>
				</li>			
			</ul>
